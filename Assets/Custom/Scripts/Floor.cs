...
namespace CULibrary
{
    public class Floor
    {
        public static GameObject baseMainFloorGameObject;
        public static GameObject baseUpperFloorGameObject;
        ...
        public Floor(int floorIndex, List<Book> books)
        {
            ...
            if (floorIndex == 0)
            {
                this.floorObj = UnityEngine.Object.Instantiate(baseMainFloorGameObject);
            }
            else
            {
